            ...
            <div className="flex flex-col gap-8 p-6 md:p-8">
                <div className="flex items-center justify-between">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-3xl font-bold tracking-tight">Dokumen Kutipan RL</h1>
                ...
                <Card className="rounded-2xl shadow-sm border-slate-200/60 dark:border-slate-800">
                        ...
                        <div className="p-6 bg-slate-50/50 dark:bg-slate-900/20 border-b border-slate-100 dark:border-slate-800">
                            <form onSubmit={handleAddSubmit} className="flex gap-4 items-end max-w-lg">
                                <div className="flex-1 space-y-2">
                                    ...
                                    />
                                    <p className="text-[10px] text-muted-foreground">Format: <span className="font-medium text-slate-600 dark:text-slate-400">{nomorPengajuan ? `${nomorPengajuan}/K-RL/2026` : '.../K-RL/2026'}</span></p>
                                </div>
                    ...
                    <CardContent className="p-0">
                        ...
                        <div className="p-5 border-t border-slate-100 dark:border-slate-800/60 flex flex-col sm:flex-row items-center justify-between text-sm text-slate-500 dark:text-slate-400 gap-4">
                            <span>Menampilkan <span className="font-medium text-slate-900 dark:text-white">{documents.data.length}</span> dari total <span className="font-medium text-slate-900 dark:text-white">{documents.total}</span> pengajuan</span>
