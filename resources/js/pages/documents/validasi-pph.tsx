                ...
                <div className="flex items-center justify-between">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-slate-500 transition-colors duration-300 dark:text-zinc-400">
                            Kelola status validasi PPh dokumen lelang.
                        </p>
                    </div>
                </div>
                    ...
                    <CardHeader className="flex flex-col items-center justify-between gap-4 border-b border-slate-100 pb-5 transition-colors duration-300 md:flex-row dark:border-zinc-800/50">
                        ...
                        <div className="flex w-full items-center gap-3 md:w-auto">
                            ...
                            >
                                <div className="relative w-full md:w-64">
                                    ...
                                    <Input
                                        ...
                                        className="w-full rounded-full border-slate-200 bg-slate-50 pl-9 text-slate-900 shadow-sm ring-offset-white transition-all duration-300 focus-visible:ring-2 focus-visible:ring-emerald-500 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100 dark:ring-offset-zinc-950"
                                    />
                                </div>
                                <select
                                    value={status}
                                    onChange={(e) => setStatus(e.target.value)}
                                    className="h-10 rounded-full border border-slate-200 bg-slate-50 px-4 text-sm font-medium text-slate-700 shadow-sm transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100"
                                >
                            ...
                            <Button
                                ...
                                className="gap-2 rounded-full bg-emerald-600 px-5 whitespace-nowrap text-white shadow-sm transition-all duration-300 hover:bg-emerald-700 hover:shadow-md"
                            >
                            ...
                            >
                                <div className="flex-1 space-y-2">
                                    <label className="text-sm font-semibold text-slate-700 transition-colors duration-300 dark:text-zinc-300">
                                        Nomor Validasi Baru (angka saja)
                                    </label>
                                    <Input
                                        required
                                        ...
                                        className="border-slate-200 bg-white text-slate-900 shadow-sm ring-offset-white transition-all duration-300 focus-visible:ring-2 focus-visible:ring-emerald-500 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100 dark:ring-offset-zinc-950"
                                    />
                                    <p className="text-[10px] text-slate-500 transition-colors duration-300 dark:text-zinc-400">
                                        Format:{' '}
                                        <span className="font-bold text-slate-700 dark:text-zinc-300">
                                            {nomorPengajuan
                                                ? `${nomorPengajuan}/V-PPh/2026`
                                                : '.../V-PPh/2026'}
                                        </span>
                                    </p>
                                </div>
                                <Button
                                    type="submit"
                                    disabled={processing}
                                    className={`rounded-full bg-emerald-600 px-6 text-white transition-all duration-300 hover:bg-emerald-700 ${processing ? 'cursor-not-allowed opacity-50' : ''}`}
                                >
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-6">
                                                        <select
                                                            ...
                                                            className={`cursor-pointer appearance-none rounded-full border px-4 py-2 text-xs font-bold ring-offset-white transition-all duration-300 outline-none hover:opacity-80 focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 dark:ring-offset-zinc-900 ${getStatusColor(doc.status_proses)}`}
                                                        >
                                                            {statusOptions
                                                                .filter(
                                                                    (opt) =>
                                    ...
                                    (link: any, index: number) =>
                                        link.url ? (
                                            <Button
                                                ...
                                                size="sm"
                                                className={`h-9 min-w-9 rounded-full px-3 font-bold transition-all duration-300 ${link.active ? 'border-transparent bg-emerald-600 text-white shadow-sm hover:bg-emerald-700' : 'border-slate-200 text-slate-600 hover:bg-slate-100 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800'}`}
                                                onClick={() =>
                                                    router.get(
                                                        link.url,
                                                        { search, status },
