                            ...
                            >
                                <div className="relative w-full md:w-64">
                                    ...
                                    <Input
                                        ...
                                        className="w-full rounded-full border-white/20 bg-white/10 pl-9 text-white shadow-lg ring-offset-transparent transition-all duration-300 placeholder:text-blue-100 focus-visible:ring-2 focus-visible:ring-blue-500"
                                    />
                                </div>
                                <select
                                    value={status}
                                    ...
                                    className="h-10 rounded-full border border-white/20 bg-white/10 px-4 text-sm font-medium text-white shadow-lg backdrop-blur-lg transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                                >
                            ...
                            >
                                <div className="flex-1 space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="border-white/20 bg-white/10 text-white shadow-lg ring-offset-transparent transition-all duration-300 placeholder:text-blue-100 focus-visible:ring-2 focus-visible:ring-blue-500"
                                    />
                                                ...
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <select
                                                            ...
                                                            className={`cursor-pointer appearance-none rounded-full border px-4 py-2 text-xs font-semibold ring-offset-white transition-all duration-300 outline-none hover:opacity-80 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 ${getStatusColor(doc.status_proses)}`}
                                                        >
                                                            {statusOptions
                                                                .filter(
                                                                    (opt) =>
